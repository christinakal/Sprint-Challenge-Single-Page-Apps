...
> Answer: Benefits using Client-side routing are: 1. Routing between views is generally faster, because less data is processed and 2.Smooth transitions and animations between views are easier to implement. 
